...
"""
function rfmip_clear_sky_lw(ds, optical_props_constructor)
    ...
    p_lay_all, p_lev_all, t_lay_all, t_lev_all =
        read_and_block_pt(ds[:rfmip], block_size)
    #
    ...
    #
    gas_conc_array =
        read_and_block_gases_ty(ds[:rfmip], block_size, kdist_gas_names)

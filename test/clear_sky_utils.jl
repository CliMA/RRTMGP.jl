...
function clear_sky(
    ...
    # @info flux_dn_sw[1,9], flux_dn_sw[end,9]
    # @info comp_flux_dn_sw[1,9], comp_flux_dn_sw[end,9]
    # @info flux_up_sw[1,9], flux_up_sw[end,9]
    # @info comp_flux_up_sw[1,9], comp_flux_up_sw[end,9]
    #@info extrema(flux_up_sw .- comp_flux_up_sw)
    #@info extrema(flux_dn_sw .- comp_flux_dn_sw)
    #@info extrema(flux_net_sw .- comp_flux_net_sw)
    @info mean(flux_up_sw[1,:] .- comp_flux_up_sw[1,:])
    @info mean(flux_dn_sw[1,:] .- comp_flux_dn_sw[1,:])
    @info extrema(flux_up_sw[end,:] .- comp_flux_up_sw[end,:])
    @info extrema(flux_dn_sw[end,:] .- comp_flux_dn_sw[end,:])

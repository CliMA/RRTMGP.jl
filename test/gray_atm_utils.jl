...
function gray_atmos_sw_test(
    ...
    cos_zenith = DA{FT, 1}(undef, ncol)   # cosine of solar zenith angle in radians
    ...
    cos_zenith .= cos(deg2rad * 52.95) #acsc(FT(1.66))               # corresponding to ~52.95 deg zenith angle    

...
function compute_gas_taus!(jtemp, jpress, jeta, tropo, fmajor, this::ty_gas_optics_rrtmgp{FT},
  ...
  @timeit to_gor "interpolation!" interpolation!(jtemp,fmajor,fminor,col_mix,tropo,jeta,jpress,
          ...
          this.ref.press_log,
          this.ref.temp,
          this.ref.press_log_delta,
          this.ref.temp_min,
          this.ref.temp_delta,
          this.ref.press_trop_log,
          this.ref.vmr,
          play,
          tlay,
          col_gas)
  @timeit to_gor "compute_tau_absorption!" compute_tau_absorption!(tau,
          ...
          this.lower_aux.idx_minor,
          this.upper_aux.idx_minor,
          this.lower_aux.idx_minor_scaling,
          this.upper_aux.idx_minor_scaling,
          this.lower.kminor_start,
          this.upper.kminor_start,
          tropo,

...
export @hascuda,
    AbstractArchitecture, CPU, GPU, device, architecture, array_type

"""
    AbstractArchitecture
Abstract supertype for architectures supported by RRTMGP.
"""
abstract type AbstractArchitecture end

"""
    CPU <: AbstractArchitecture
Run RRTMGP on a single-core of a CPU.
"""
struct CPU <: AbstractArchitecture end

"""
    GPU <: AbstractArchitecture
Run RRTMGP on a single NVIDIA CUDA GPU.
"""

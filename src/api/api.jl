...
"""
update_lw_fluxes!(s::RRTMGPSolver) = update_lw_fluxes!(s, radiation_method(s))

update_lw_fluxes!(s::RRTMGPSolver, ::GrayRadiation) = RTESolver.solve_lw!(longwave_solver(s), atmospheric_state(s))
...
function update_lw_fluxes!(s::RRTMGPSolver, ::AllSkyRadiationWithClearSkyDiagnostics)
    ...
    parent(clear_lw_flux(s)) .= parent(lw_flux(s))
...
"""
update_sw_fluxes!(s::RRTMGPSolver) = update_sw_fluxes!(s, radiation_method(s))

update_sw_fluxes!(s::RRTMGPSolver, ::GrayRadiation) = RTESolver.solve_sw!(shortwave_solver(s), atmospheric_state(s))
...
function update_sw_fluxes!(s::RRTMGPSolver, ::AllSkyRadiationWithClearSkyDiagnostics)
    ...
    parent(clear_sw_flux(s)) .= parent(sw_flux(s))

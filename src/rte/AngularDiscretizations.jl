...
struct GaussQuadrature{FT, I} <: AbstractAngularDiscretization{FT, I}
  ...
  function GaussQuadrature(::Type{FT}, n_gauss_angles::I) where {FT<:AbstractFloat,I<:Int}
    ...
    table2 = (FT[0.5000000000 60.0000000 1.0000000000 0.6666666667 48.1896852 0.5000000000; # 1 points
    ...
    gauss_wts = reshape(FT[moment_k1[1,end],zeros(FT,3)...,
                 reverse(moment_k1[2:3,end])...,zeros(FT,2)...,
                 reverse(moment_k1[4:6,end])...,zeros(FT,1)...,

...
#contains
  ...
  #-------------------------------------------------------------------------------------------------
  function any_vals_less_than_1D(array, minVal)
...
##endif
  return any_vals_less_than_1D
end
  #-------------------------------------------------------------------------------------------------
  function any_vals_less_than_2D(array, minVal)
#    real(wp), dimension(:,:), intent(in) :: array
#    real(wp),                 intent(in) :: minVal
...
##endif
    return any_vals_less_than_2D
  end
#-------------------------------------------------------------------------------------------------
  function any_vals_less_than_3D(array, minVal)
#    real(wp), dimension(:,:,:), intent(in) :: array
#    real(wp),                   intent(in) :: minVal
...
##endif
  return any_vals_less_than_3D
  end
  #-------------------------------------------------------------------------------------------------
  # Values outside a range
  #-------------------------------------------------------------------------------------------------
  function any_vals_outside_1D(array, minVal, maxVal)
#    real(wp), dimension(:), intent(in) :: array
...
##else
    any_vals_outside_1D = any(array .< minVal || array .> maxVal)
##endif
    return any_vals_outside_1D
  end
# ----------------------------------------------------------
  function any_vals_outside_2D(array, minVal, maxVal)
#    real(wp), dimension(:,:), intent(in) :: array
#    real(wp),                 intent(in) :: minVal, maxVal
...
##else
    any_vals_outside_2D = any( array .< minVal || array .> maxVal)
##endif
    return any_vals_outside_2D
  end
# ----------------------------------------------------------
  function any_vals_outside_3D(array, minVal, maxVal)
#    real(wp), dimension(:,:,:), intent(in) :: array
#    real(wp),                   intent(in) :: minVal, maxVal
...
##else
    any_vals_outside_3D = any(array .< minVal || array .> maxVal)
##endif

    return any_vals_outside_3D
  end
  #-------------------------------------------------------------------------------------------------
  # Initializing arrays to 0
  #-------------------------------------------------------------------------------------------------
  function zero_array_1D(ni, array) # bind(C, name="zero_array_1D")
...
#    #$acc parallel loop copyout(array)
  ...
  # ----------------------------------------------------------
  function zero_array_3D(ni, nj, nk, array) # bind(C, name="zero_array_3D")
...
#    #$acc parallel loop collapse(3) copyout(array)
  ...
  # ----------------------------------------------------------
  function zero_array_4D(ni, nj, nk, nl, array) # bind(C, name="zero_array_4D")

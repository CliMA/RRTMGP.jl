...
function rte_lw_solve!(
    ...
    @inbounds begin
        ClimaComms.@threaded device for gcol in 1:ncol
            ...
            adding_lw!(op, flux_lw, src_lw, bcs_lw, gcol, igpt, ibnd, nlev, ncol)
            for ilev in 1:nlev
    ...
    @inbounds begin
        for igpt in 1:n_gpt
            ClimaComms.@threaded device for gcol in 1:ncol
                ...
                adding_lw!(op, flux, src_lw, bcs_lw, gcol, igpt, ibnd, nlev, ncol)
                if igpt == 1
...
"""
    rte_lw_2stream_coeffs(τ::FT, ssa::FT, g::FT, lev_src_bot::FT, lev_src_top::FT) where {FT}
...
"""
@inline function rte_lw_2stream_coeffs(τ, ssa, g, lev_src_bot, lev_src_top)
    FT = eltype(τ)
...
@inline function adding_lw!(
    ...
    @inbounds for ilev in 1:nlay
        ...
        Rdif, Tdif, src_up, src_dn = rte_lw_2stream_coeffs(τ_lay, ssa_lay, g_lay, lev_src_bot, lev_src_top)
    ...
    @inbounds for ilev in nlay:-1:1
        ...
        τ_lay, ssa_lay, g_lay = τ[ilev, gcol], ssa[ilev, gcol], g[ilev, gcol]
        Rdif, Tdif, _, src_dn = rte_lw_2stream_coeffs(τ_lay, ssa_lay, g_lay, lev_src_bot, lev_src_top)
